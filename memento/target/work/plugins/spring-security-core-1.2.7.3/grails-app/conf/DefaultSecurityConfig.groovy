...
security {
	...
	userLookup.userDomainClassName = 'SecUsuario'
	...
	// successHandler
	successHandler.defaultTargetUrl = '/objetivo/index'
	successHandler.alwaysUseDefault = false
	successHandler.targetUrlParameter = 'objetivo/index' // 'spring-security-redirect'
